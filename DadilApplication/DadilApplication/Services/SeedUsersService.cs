...
namespace DadilApplication.Services
{
    public class SeedUsersService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            await CriarUsuarioAsync(userManager, "profmiqueias", "Aprovados@123", "profmiqueias@email.com", "User");
            ...
            if (!await context.Denuncias!.AnyAsync())
            {
                ...
                var profmiqueias = await userManager.FindByNameAsync("profmiqueias");
                ...
                var denuncias = new List<Denuncia>
                {
                    ...
                    new() { Descricao = "Lixo acumulado na calçada", Localizacao = "Rua A, Bairro X", FotoUrl = "https://picsum.photos/200", Status = StatusEnum.Pendente, DataCriacao = DateTime.UtcNow, UsuarioId = profmiqueias!.Id },
                    new() { Descricao = "Queima de lixo a céu aberto", Localizacao = "Av B, Bairro Y", FotoUrl = "https://picsum.photos/200/300", Status = StatusEnum.Pendente, DataCriacao = DateTime.UtcNow, UsuarioId = profmiqueias.Id },
                    new() { Descricao = "Descarte irregular em área verde", Localizacao = "Travessa C, Bairro Z", FotoUrl = "https://picsum.photos/400", Status = StatusEnum.EmAnalise, DataCriacao = DateTime.UtcNow, UsuarioId = profmiqueias.Id },
                    new() { Descricao = "Entulho jogado em via pública", Localizacao = "Rua D, Centro", FotoUrl = "https://picsum.photos/500", Status = StatusEnum.EmAnalise, DataCriacao = DateTime.UtcNow, UsuarioId = profmiqueias.Id },
                    new() { Descricao = "Descaso com a população de Caucaia", Localizacao = "Rua D, Caucaia", FotoUrl = "https://picsum.photos/500", Status = StatusEnum.Resolvido, DataCriacao = DateTime.UtcNow, UsuarioId = profmiqueias.Id },
                    new() { Descricao = "Acúmulo de lixo em terreno baldio", Localizacao = "Rua E, Bairro Q", FotoUrl = "https://picsum.photos/600", Status = StatusEnum.Pendente, DataCriacao = DateTime.UtcNow, UsuarioId = profmiqueias.Id },
                };
